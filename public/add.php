...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="col-12">
        ...
        <!--
          enctype bắt buộc để PHP nhận được file upload.
          Form vẫn submit bằng POST bình thường,
          KHÔNG dùng AJAX.
        -->
        <form
          method="post"
          ...
          <div class="mb-3">
            ...
            <textarea
              ...
              class="form-control<?= isset($errors['notes'])
                ? ' is-invalid'
                : '' ?>"
              placeholder="Enter notes (maximum character limit: 255)"><?= isset($_POST['notes'])
  ...
  <!--
    JavaScript chỉ dùng để preview ảnh.
    Không dùng JavaScript/AJAX để submit.
  -->
  <script>
    ...
    avatarInput.addEventListener('change', function () {
      ...
      // Kiểm tra loại file ở phía client
